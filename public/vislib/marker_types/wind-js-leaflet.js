...
define(function (require) {
  ...
  // var demoJson = require('./demo_json');
...
// shim layer with setTimeout fallback
  ...
  var WindJSHelper = {
    ...
    loadWindData: function loadWindData() {
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          WindJSHelper.data = test;
          WindJSHelper.initWindy(test);
        }
      });
      ...
      function testData(data) {
        var nx = 60,
          ny = 60,
          begin = 360 * 50,
          end = begin + (nx * ny); // 360 * n;

        return data.map(function (d) {
          d.header.nx = nx;
          d.header.ny = ny;
          d.header.numberPoints = nx * ny;

          d.header.la1 = 50;
          // d.header.lo1 = 10;
          d.header.dx = 2;
          d.data = d.data.slice(begin, end);
          return d;
        })
      }
    },
    ...
    //
    //   console.log('using local data..');
    //   WindJSHelper.data = demoJson;
    //   WindJSHelper.initWindy(demoJson);
    //   // $.getJSON('plugins/tnf_tilemap/vislib/marker_types/demo.json', function (data) {
    //   //   WindJSHelper.data = data;
    //   //   WindJSHelper.initWindy(data);
    //   // });
    // },
    ...
    //     return;
    //   }
    //   WindJSHelper.initWindy(WindJSHelper.data);
    // },
    ...
    initWindy: function initWindy(data) {
      ...
      console.log('test data on wind-js-leaflet', data);
